	...
	RM.CaseForm = {
		...
		intakeFormHtml: function (ctx, options) {
			...
			return header +
				...
				'<div class="form-row form-row-2">' +
				'<div class="form-group"><label for="client-name">' + RM.Components.escapeHtml(t(c + '.clientName')) + '</label><input type="text" id="client-name" required autocomplete="name"' + dis + '></div>' +
				'<div class="form-group"><label for="client-dob">' + RM.Components.escapeHtml(t(c + '.dateOfBirth')) + '</label><input type="date" id="client-dob"' + dis + '></div></div>' +
				'<div class="form-row form-row-2">' +
				'<div class="form-group"><label for="client-phone">' + RM.Components.escapeHtml(t(c + '.phone')) + '</label><input type="tel" id="client-phone" autocomplete="tel"' + dis + '></div>' +
