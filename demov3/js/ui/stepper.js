	...
	RM.Stepper = {
		render: function (containerId, activeTabId, client) {
			...
			var html = '<div class="stepper-wrap">' +
				...
				'<span class="step-legend-item step-legend-complete">Complete</span>' +
				'<span class="step-legend-item step-legend-in-progress">In progress</span>' +
				'<span class="step-legend-item step-legend-not-started">Not started</span>' +
				'</div>' +
				'<nav class="workflow-stepper workflow-stepper-fit" aria-label="Case process stages"><ol>';
			...
			stages.forEach(function (stage) {
				...
				var statusText = STATUS_LABEL[status] || status;
				var title = stage.label + ' — ' + statusText;
				if (stage.deliverable) {
					title += ' · Deliverable: ' + stage.deliverable;
				}
