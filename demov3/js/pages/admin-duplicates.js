...
(function () {
	...
	function openCompareModal(pair, idx) {
		var modalBody =
			...
			'<button type="button" class="btn btn-primary" id="dup-modal-merge">Merge records</button>' +
			'<button type="button" class="btn btn-secondary" id="dup-modal-dismiss">Dismiss match</button>' +
			'</div>';
