...
(function () {
	...
	RM.ReportSections = {
		...
		buildExtendedHtml: function (prefix) {
			return tierHeading('executive') +
				sectionSubheading('pages.reports.tierExecutiveLead') +
				...
				tierHeading('operational') +
				sectionSubheading('pages.reports.tierOperationalLead') +
				...
				tierHeading('integrity') +
				sectionSubheading('pages.reports.tierIntegrityLead') +
